...
async function fetchStocks() {
  ...
  try {
    res = await request(
      "https://api.takasumibot.com/v3/stock"
    );
  } catch {
    throw new Error("株データ取得に失敗しました");
  }

  if (res.statusCode !== 200) {
    throw new Error("株APIエラー");
  }
